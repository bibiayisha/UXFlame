      ...
      <Grid className='container py-28' container spacing={{ sm:0, md: 7 }}>
        ...
        <Grid item xs={12} md={6} lg={5}>
          <div className='md:mt-0 mt-20 md:text-left text-center'>
            ...
            <div className='mb-5 flex md:flex-row flex-col justify-between md:items-start items-center w-11/12'>
              <div className='mr-4 mt-2 mb-4 md:mb-0'><img width={'100px'} src={images.body.bell}/></div>
